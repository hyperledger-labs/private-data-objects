...
{
    static sgx_sha_state_handle_t InvalidHandle() { return NULL; }
...
{
    static sgx_cmac_state_handle_t InvalidHandle() { return NULL; }
...
{
    static sgx_ecc_state_handle_t InvalidHandle() { return NULL; }
...
typedef AutoHandle<sgx_ecc_state_handle_t, SgxEcc256StateHandleTraits> SgxEcc256StateHandle;
