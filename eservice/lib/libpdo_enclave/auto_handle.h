...
public:
    ...
    // Returns:     Nothing
    ////////////////////////////////////////////////////////////////////////////
    AutoHandle() : m_handle(Traits::InvalidHandle()) {}  // AutoHandle::AutoHandle
    ...
    // Returns:     Nothing
    ////////////////////////////////////////////////////////////////////////////
    explicit AutoHandle(const HandleType& handle) : m_handle(handle) {}  // AutoHandle::AutoHandle
    ...
    // Returns:     Nothing
    ////////////////////////////////////////////////////////////////////////////
    AutoHandle(AutoHandle<HandleType, Traits>& other)
        : m_handle(other.Transfer()) {}  // AutoHandle::AutoHandle
    ...
    // Returns:     Nothing
    ////////////////////////////////////////////////////////////////////////////
    ~AutoHandle() { this->Cleanup(); }  // AutoHandle::~AutoHandle
    ...
    // Returns:     This object.
    ////////////////////////////////////////////////////////////////////////////
    AutoHandle<HandleType, Traits>& operator=(AutoHandle<HandleType, Traits>& other);
    ...
    ////////////////////////////////////////////////////////////////////////////
    operator HandleType() const { return this->Get(); }  // operator HandleType
    ...
    // Returns:     The underlying handle.
    ////////////////////////////////////////////////////////////////////////////
    HandleType* operator&() { return &m_handle; }  // operator HandleType
    ...
    // Returns:     The underlying handle.
    ////////////////////////////////////////////////////////////////////////////
    HandleType Get() const { return m_handle; }  // AutoHandle::get
    ...
    ////////////////////////////////////////////////////////////////////////////
    bool IsValid() const { return !(Traits::InvalidHandle() == this->Get()); }  // AutoHandle::get
...
template <typename HandleType, typename Traits>
void AutoHandle<HandleType, Traits>::Assume(HandleType handle)
{
