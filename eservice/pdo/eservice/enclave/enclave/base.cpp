...
static EnclaveQueue<int> g_EnclaveReadyQueue;
...
// XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
int pdo::enclave_api::base::GetReadyEnclaveIndex()
{
    return g_EnclaveReadyQueue.pop();
} // pdo::enclave_api::base::GetReadyEnclaveIndex

// XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
void pdo::enclave_api::base::PutReadyEnclaveIndex(int index)
{
    g_EnclaveReadyQueue.push(index);
} // pdo::enclave_api::base::PutReadyEnclaveIndex
