...
def __find_enclave_library(config) :
    ...
    if enclave_file_path :
        ...
        for path in search_path :
            ...
            if os.path.exists(enclave_file) :
                logger.info("Eservice Enclave Lib Exits")
                return enclave_file
