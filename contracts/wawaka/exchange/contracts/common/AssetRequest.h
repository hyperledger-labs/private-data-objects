...
namespace exchange
{
    ...
    {
    public:
        bool get_issuer_verifying_key(ww::value::String& value) const;
        ...
        bool set_issuer_verifying_key(const ww::value::String& value);
        ...
        bool check(const ww::exchange::AuthoritativeAsset& authoritative_asset) const;
