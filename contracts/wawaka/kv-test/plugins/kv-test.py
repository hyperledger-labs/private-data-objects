...
def __command_kv__(state, bindings, pargs) :
    ...
    if options.command == 'get' :
        ...
        pblocks.sync_block_store(pblocks.local_block_manager(), eservice_client, kv.hash_identity)
        ...
        kv.hash_identity = result
        count = pblocks.sync_block_store(eservice_client, pblocks.local_block_manager(), kv.hash_identity)
