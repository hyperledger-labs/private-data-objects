...
static const char* StrToUint(const char* strPtr,
	unsigned int* ptrVal,
...
ErrorInfo errorInfo[] =
{
	...
	{ STUB_INTERPRETOR_ERR_STRING_TO_INT, "ERROR: Codeinit String to Int"},
	{0, NULL}
};
...
int IntKeyState::Init(const char* str)
{
	...
	if ((str = StrToUint(str, &terminated)) != NULL)
	{
		str++;
		if (StrToUint(str, &value) != NULL)
		{
