...
extern bool SignatureTestSuite(pcrypto::sig::SigCurve sigCurve);
...
int pcrypto::testCrypto()
{
    ...
    // Test signature schemes
    {
        ...
        if (! SignatureTestSuite(pcrypto::sig::SigCurve::SECP256K1))
            return -1;
    }
    {
        // test secp384r1 scheme
        if (! SignatureTestSuite(pcrypto::sig::SigCurve::SECP384R1))
            return -1;
    }
