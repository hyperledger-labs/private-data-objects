...
void ContractCompilationReport::Unpack(const JSON_Object* object) {
    ...
    // ledger's signature on compiler's key is optional
...
std::string ContractCompilationReport::Pack(void) const {
    ...
    jret = json_object_dotset_string(report_object, "CompilerConfiguration",
    ...
    std::string source_hash = ByteArrayToBase64EncodedString(source_hash_);
