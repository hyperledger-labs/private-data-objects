...
*/
extern unsigned char ias_report_signing_ca_cert_der[];
extern unsigned int ias_report_signing_ca_cert_der_len;
...
signature verification procedure. However, the same certificate (or new ones)
may as well be downloaded and verified against the IAS CA certificate above.
*/
extern unsigned char ias_report_signing_cert_der[];
extern unsigned int ias_report_signing_cert_der_len;
