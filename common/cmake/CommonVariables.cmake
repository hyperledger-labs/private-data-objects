...
IF (PDO_INTERPRETER STREQUAL "gipsy")
  SET(COMMON_INTERPRETER_LIBRARIES "gipsy" "tinyscheme" ${INTERPRETER_LIB_NAME})
ELSEIF (PDO_INTERPRETER MATCHES "^wawaka")
...
SET(TINYSCHEME_INCLUDE_DIRS ${COMMON_SOURCE_DIR}/packages/tinyscheme)
