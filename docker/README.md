...
mode (in which case, though, you will have to put proper sgx key & cert
files (`sgx_spid.txt`,  `sgx_spid_key_cert.pem`,
`sgx_ias_key.pem`) into the sgx sub-directory or define the
`PDO_SGX_KEY_ROOT` environment variable.
